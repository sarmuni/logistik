                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <form action="<?= base_url('auth/registration'); ?>" method="post">
                                ...
                                <button type="submit" value="Log In" class="btn btn-block btn-primary">Registrasi</button>

                                <span class="d-block text-center my-4 text-muted">Sudah punya akun <a href="<?= base_url('auth'); ?>"> Login? </a></span>
