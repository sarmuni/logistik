...
<body>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="mb-4">
                                ...
                                <p class="mb-4">System Infromasi Antaran Logistik</p>
                            </div>
                            ...
                            <form action="<?= base_url('auth/forgotpassword'); ?>" method="post">
                                ...
                                <button type="submit" value="Log In" class="btn btn-block btn-primary">Reset Password</button>

                                <span class="d-block text-center my-4 text-muted">Belum punya akun <a href="<?= base_url('auth/registration'); ?>"> Registrasi! </a></span>
    ...
    <span class="d-block text-center my-4 text-muted">&mdash; Copyrigth &copy; <?php echo date('Y'); ?> PT. Antaran Logistik. All Rights Reserved. &mdash;</span>
