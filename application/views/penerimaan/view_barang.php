        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <!-- <div class="form-group row">
                        <label for="input" class="col-sm-2 col-form-label">Kelurahan</label>
                        <div class="col-sm-10">
                            <input type="text" readonly="readonly" value="<?php echo $row['kelurahan']; ?>" class="form-control" autocomplete="off">
                        </div>
                    </div> -->
                    <div class="form-group row">
...
<div class="card mb-3">
    ...
    <div class="card-body">
        <?php if ($user['role_id'] == 1) { ?>
            ...
            <a role="button" href="<?php base_url('penerimaan'); ?>" class="btn bg-danger" title="Refresh data barang">
                <i class="fas fa-sync-alt"></i>
            </a>
        <?php } ?>
        <a role="button" href="<?php echo base_url('penerimaan'); ?>" class="btn bg-danger" title="Kembali">
        ...
        <?php if ($user['role_id'] == 1 or $user['role_id'] == 3) { ?>
            ...
            <a role="button" href="<?php echo site_url(); ?>penerimaan/kirim_gudang/<?php echo $row['no_resi']; ?>" id="terima_agen" class="btn bg-info kirim_gudang" title="Kirim Ke Gudang">
                <i class="fas fa-clipboard-check"> Kirim Ke Gudang</i>
            </a>
        <?php } ?>
        <hr>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } ?>
                                <center><a role="button" href="<?php echo site_url(); ?>cetak/label_barang/<?php echo $row['no_resi_barang']; ?>" target="_blank" id="label_barang" class="btn bg-danger" title="Cetak Label Barang">
                                        <i class="fas fa-print"></i>
                                    </a></center>
                            </td>
                        </tr>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?= form_error('nama_barang', '<p style="color:red; font-size:12px;">', '</p>'); ?>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <?php foreach ($daftar_barang as $row) { ?>
                                    <div class="form-group col-md-6">
                                        <label for="daftar_barang"><?php echo $row['nama_barang']; ?></label>

                                        <?php
                                        $id_barang = $row['id'];
                                        $detail_barang = "SELECT * FROM tabel_master_barang_detail WHERE id_barang=$id_barang";
                                        $daftar_barang_detail = $this->db->query($detail_barang)->result_array();
                                        ?>

                                        <?php foreach ($daftar_barang_detail as $row) { ?>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="checkbox" name="<?php echo $row['id_barang']; ?>"> <?php echo $row['nama_barang']; ?>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
