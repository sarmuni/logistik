                        ...
                        <form autocomplete="off" action="<?php echo base_url('harga/add'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="ukuran" class="form-control" id="ukuran" value="<?= set_value('ukuran'); ?>">
                                    <?= form_error('ukuran', '<p style="color:red; font-size:12px;">', '</p>'); ?>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nominal">Nominal</label>
                                    <input type="text" name="nominal" class="form-control" id="nominal" value="<?= set_value('nominal'); ?>">
