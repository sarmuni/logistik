...
<div class="col-12">
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <a role="button" href="#" class="btn bg-danger" title="Tambah Data Kurir" data-toggle="modal" data-target=".tambah_kurir">
                <i class="fas fa-user-plus"></i>
            </a>

            <a role="button" href="#" class="btn bg-danger" title="Cetak Data Kurir">
                <i class="fas fa-print"></i>
            </a>
            <a role="button" href="<?php base_url('kurir'); ?>" class="btn bg-danger" title="Refresh Data Kurir">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php if ($row['status'] == 0) { ?>
                                    <center><a role="button" href="<?php echo site_url(); ?>kurir/publish/<?php echo $row['id']; ?>" id="publish" class="btn bg-danger publish" title="Aktif">
                                            <i class="fas fa-eye"></i>
                                        </a></center>
                                <?php } else { ?>
                                    <center><a role="button" href="<?php echo site_url(); ?>kurir/unpublish/<?php echo $row['id']; ?>" id="unpublish" class="btn bg-danger unpublish" title="Non Aktif">
                            ...
                            <td>
                                <a role="button" href="#" class="btn bg-danger" title="Edit Data Kurir" data-toggle="modal" data-target="#edit_kurir<?php echo $row['id']; ?>">
                                    <i class="fas fa-user-edit"></i>
                                </a>
                                <?php if ($row['status'] == 1) { ?>
                                    <a role="button" href="<?php echo site_url(); ?>kurir/delete/<?php echo $row['id']; ?>" id="hapus" class="btn bg-danger tombol-hapus" title="Hapus Data Kurir">
                                        <i class="fas fa-trash-alt"></i>
                                    </a>
                                <?php } ?>
                                <a role="button" href="#" class="btn bg-danger" title="Selengkapnya" data-toggle="modal" data-target="#view_kurir<?php echo $row['id']; ?>">
...
<!-- Modal Add -->
<div class="modal fade tambah_kurir" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Add Kurir</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form autocomplete="off" action="<?php echo base_url('kurir/add'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="negara" class="form-control" id="negara" value="<?= set_value('negara'); ?>">
...
?>
    ...
    <div class="modal fade edit_kurir" id="edit_kurir<?php echo $id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Edit Kurir</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form autocomplete="off" action="<?php echo base_url('kurir/edit/' . $id); ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="nik">NIK</label>
...
?>
    ...
    <div class="modal fade view_kurir" id="view_kurir<?php echo $id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">View Data Kurir</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form autocomplete="off" action="<?php echo base_url('kurir/edit/' . $id); ?>" method="POST">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="nik">NIK</label>
                                        <input type="text" name="nik" <?php echo $publish; ?> value="<?php echo $nik; ?>" class="form-control" id="nik">
